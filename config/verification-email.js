...
exports.sendVerificationEmail = function sendVerificationEmailFunction(email, accHash) {
  ...
  const msg = {
    ...
    html: "<strong>Account has been created!</strong><br><p>Validate your email here:<br>  <a href=\"https://drip-web-app.herokuapp.com/verification?hash=" + accHash + "\">Validate</a></p>"
